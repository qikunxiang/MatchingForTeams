classdef MatchTeam2DBusinessLocation < LSIPMinCuttingPlaneAlgo
    % Class for the matching for teams problem about business location
    ...
    methods(Access = public)
        function obj = MatchTeam2DBusinessLocation(marginals, costfuncs, ...
    ...
    methods(Access = protected)
        ...
        function inside = doCheckIfInsideQualitySpace(obj, pts)
            ...
            lb_list = all(pts >= check_model.lb' ...
                - MatchTeam2DBusinessLocation.INSIDE_TOLERANCE, 2);

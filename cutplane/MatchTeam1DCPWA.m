classdef MatchTeam1DCPWA < LSIPMinCuttingPlaneAlgo
    ...
    methods(Access = public)
        function obj = MatchTeam1DCPWA(marginals, costfuncs, ...
            ...
            if ~isfield(quality_repr, 'eq_A') || isempty(quality_repr.eq_A) ...
                    || ~isfield(quality_repr, 'eq_rhs') ...
                    || isempty(quality_repr.eq_rhs)
            ...
            if ~isfield(quality_repr, 'ineq_A') || isempty(quality_repr.ineq_A) ...
                    || ~isfield(quality_repr, 'ineq_rhs') ...
                    || isempty(quality_repr.ineq_rhs)
            ...
            obj.Quality.GurobiModel.A = sparse([quality_repr.eq_A; ...
                quality_repr.ineq_A]);
            obj.Quality.GurobiModel.rhs = [quality_repr.eq_rhs; ...
                quality_repr.ineq_rhs];

...
for marg_id = 1:marg_num
    ...
    pc = pcolor(quality_transfuncs_grid_x, quality_transfuncs_grid_y, ...
        reshape(MT_transfuncs_cell{plot_index}(:, marg_id), size(quality_transfuncs_grid_x, 1), size(quality_transfuncs_grid_x, 2)));

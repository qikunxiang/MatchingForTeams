...
for test_id = 1:test_num
    ...
    [MT_UB_list_disc, MT_UB_list_cont, MCsamp, MT_histpdf] = MT.getMTUpperBoundsWRepetition(MCsamp_num, MCrep_num, RS, [], ...
    ...
    log_text = sprintf(['Test %d: LB = %10.4f, UB1 = %10.4f, UB2 = %10.4f, diff1 = %10.6f, diff2 = %10.6f, ' ...

...
% Place to store global configurations of the business outlet locations experiment
% Output:
...
% path to save files
CONFIG.SAVEPATH = [CONFIG.SAVEPATH_ROOT, 'MT/BusinessLocation_Exp/'];

% path to log files
CONFIG.LOGPATH = [CONFIG.LOGPATH_ROOT, 'MT/BusinessLocation_Exp/'];
...
CONFIG.SAVEPATH_OUTPUTS_TRANSFUNCS = [CONFIG.SAVEPATH, CONFIG.FILENAME_OUTPUTS_TRANSFUNCS, '.mat'];

% file name of the couplings for plotting
CONFIG.FILENAME_COUPLINGS = 'couplings';
CONFIG.SAVEPATH_COUPLINGS = [CONFIG.SAVEPATH, CONFIG.FILENAME_COUPLINGS, '.mat'];
...
CONFIG.LOGPATH_TRANSFUNCS = [CONFIG.LOGPATH, CONFIG.LOGNAME_TRANSFUNCS, '.log'];

...
ha = tight_subplot(1, 5, [0, 0.02], [0.12, 0.02], [0.015, 0.005]);
...
for marg_id = 1:marg_num
    ...
    for samp_id = 1:MCsamp_num
        ...
        scatter(x_i(1), x_i(2), 8, 'black', 'filled', ...
            'MarkerEdgeAlpha', 0.2, 'MarkerFaceAlpha', 0.4);
        scatter(z(1), z(2), 8, 'red', 'filled', ...
            'MarkerEdgeAlpha', 0.2, 'MarkerFaceAlpha', 0.4);

        line([x_i(1), z(1)], [x_i(2), z(2)], ...
            'Color', [0, 0, 1, 0.1]);
    end
    ...
    set(gca, 'YTick', -3:1:2);
    xlabel(sprintf('$\\tilde{\\gamma}_{%d}$', marg_id), ...

...
% path to save files
CONFIG.SAVEPATH = [CONFIG.SAVEPATH_ROOT, 'MT/Benchmark1DCPWA_Exp/'];

% path to log files
CONFIG.LOGPATH = [CONFIG.LOGPATH_ROOT, 'MT/Benchmark1DCPWA_Exp/'];
...
CONFIG.SAVEPATH_SUMMARY = [CONFIG.SAVEPATH, CONFIG.FILENAME_SUMMARY, '.mat'];

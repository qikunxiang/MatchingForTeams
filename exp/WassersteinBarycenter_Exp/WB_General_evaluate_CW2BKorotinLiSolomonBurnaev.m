% Evaluate the performance of the Continuous Wasserstein-2 Barycenter method without minimax optimization (CW2B) of Korotin, Li, 
% Solomon, Burnaev via semi-discrete Wasserstein-2 OT
...
barycenter_samples = readmatrix(sprintf(CONFIG.PATHFORMAT_RESULTS_CW2BKOROTINLISOLOMONBURNAEV, test_epoch));
...
save(CONFIG.SAVEPATH_EVALUATION_CW2BKOROTINLISOLOMONBURNAEV, ...
    'objective', ...
    'W2_dist_list', ...
    '-v7.3');
% Evaluate the performance of the Neural Wasserstein Barycenter method of Fan, Taghvaei, Chen via semi-discrete Wasserstein-2 OT
...
barycenter_samples = readmatrix(sprintf(CONFIG.PATHFORMAT_RESULTS_NWBFANTAGHVAEICHEN, test_epoch));
...
save(CONFIG.SAVEPATH_EVALUATION_NWBFANTAGHVAEICHEN, ...
    'objective', ...
    'W2_dist_list', ...
    '-v7.3');
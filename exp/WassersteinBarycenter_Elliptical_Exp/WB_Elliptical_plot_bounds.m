...
x_tick = [2e3, 4e3, 6e3, 1e4, 2e4, 4e4, 6e4, 8e4];
x_tickangle = 22;
line_width = 1.25;
...
ha = tight_subplot(1, 1, [0, 0], [0.135, 0.020], [0.097, 0.012]);
axes(ha(1));
...
legend([handle_LB, handle_UB1, handle_UB2], ...
    {'$\alpha_{\mathrm{fp}}-\hat{\alpha}_{\mathrm{MT}}^{\mathrm{lb}}$', ...
    '$\hat{\alpha}_{\mathrm{MT}}^{\mathrm{ub}}-\alpha_{\mathrm{fp}}$', ...
    ['$\tilde{\alpha}_{\mathrm{MT}}^{\mathrm{ub}}' ...
    '-\alpha_{\mathrm{fp}}$']}, ...
    'Location', 'northeast', ...
    'Interpreter', 'latex', ...

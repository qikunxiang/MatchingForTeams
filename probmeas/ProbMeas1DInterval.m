classdef (Abstract) ProbMeas1DInterval < handle
    ...
    methods
        ...
        function samp_cell = conditionalRandSample(obj, ...
                atom_list, samp_num_list, rand_stream, varargin)
            ...
            assert(length(samp_num_list) == cell_num, ...
            ...
            for cell_id = 1:cell_num
                ...
                u = atom_cum_probs(chosen_atom_id) - atom_probs(chosen_atom_id) ...
                    * rand(rand_stream, samp_num_list(cell_id), 1);
                samp_cell{cell_id} = obj.evaluateInverseCDF(u, ...
                    varargin{:});
            end
        end
        ...
        function [samps, disc_samps] = randSampleCoupled(obj, samp_num, ...
            ...
            samp_cell = obj.conditionalRandSample( ...
                (1:atom_num)', samp_num_list, ...
                rand_stream, varargin{:});

classdef ProbMeas1D_CPWADens < ProbMeas1D_Interval
    ...
    methods(Access = public)
        function obj = ProbMeas1D_CPWADens(knots, dens_knots)
            ...
            obj@ProbMeas1D_Interval(knots(1), knots(end));
    ...
    methods(Access = protected)
        ...
        function integrals = doSetSimplicialTestFuncs(obj, knots)
            ...
            assert(abs(knots(1) - obj.Supp.LowerBound) < 1e-15 ...
                && abs(knots(end) - obj.Supp.UpperBound) < 1e-15, ...
